class BlackMarket::PurchaseNeuropunk < BlackMarket::BasePurchase
  ...
  TON_FEE = 10
  SELLER_USER_CHAT_ID = 5265424415
  ...
  def ton_payment
    ...
    create_user_transaction!(TON_FEE, TON_FEE / 2, 'neuropunk')
  end
  ...
  def add_praxis_balance_to_seller
    seller_user.praxis_transactions.create!(
      ...
      quantity: product.current_price / 2
    )
  end
