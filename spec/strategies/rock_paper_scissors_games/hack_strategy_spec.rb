...
RSpec.describe RockPaperScissorsGames::HackStrategy do
  describe '#pick_move' do
    let(:game) { create :rock_paper_scissors_game }

    include_examples 'first move strategy', :hack
    ...
    context 'when next round' do
      ...
      context 'when healthier' do
        it 'with higher chance choses aggressive move' do
      ...
      context 'when hurt' do
        it 'with higher chance choses safe move' do
