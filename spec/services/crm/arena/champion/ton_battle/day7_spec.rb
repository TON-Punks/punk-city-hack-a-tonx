...
RSpec.describe Crm::Arena::Champion::TonBattle::Day7 do
  ...
  context "when user's balance is positive" do
    ...
    let(:expected_text) { I18n.t("crm.arena.champion.ton_battle.day7.text") }
    let(:expected_button_text) { I18n.t("crm.arena.champion.ton_battle.day7.button") }
    ...
    context "when day1 notification sent" do
      before do
        create(:crm_notification,
          crm_type: Crm::Arena::Champion::TonBattle::Day1.name,
          user: user,
