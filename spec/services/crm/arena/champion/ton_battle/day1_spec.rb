...
RSpec.describe Crm::Arena::Champion::TonBattle::Day1 do
  ...
  context "when user's balance is positive" do
    ...
    let(:expected_text) { I18n.t("crm.arena.champion.ton_battle.day1.text") }
    let(:expected_button_text) { I18n.t("crm.arena.champion.ton_battle.day1.button") }
