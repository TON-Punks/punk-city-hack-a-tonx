...
RSpec.describe Crm::Arena::Champion::TopUp::Day7 do
  ...
  context "when user's balance is zero" do
    ...
    let(:expected_text) { I18n.t("crm.arena.champion.top_up.day7.text") }
    let(:expected_button_text) { I18n.t("crm.arena.champion.top_up.day7.button") }
    ...
    context "when day1 notification sent" do
      before do
        create(:crm_notification,
          crm_type: Crm::Arena::Champion::TopUp::Day1.name,
          user: user,
