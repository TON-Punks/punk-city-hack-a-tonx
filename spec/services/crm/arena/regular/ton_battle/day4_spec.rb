...
RSpec.describe Crm::Arena::Regular::TonBattle::Day4 do
  ...
  context "when user's balance is positive" do
    ...
    let(:expected_text) { I18n.t("crm.arena.regular.ton_battle.day4.text") }
    let(:expected_button_text) { I18n.t("crm.arena.regular.ton_battle.day4.button") }
    ...
    context "when day1 notification sent" do
      before do
        create(:crm_notification,
          crm_type: Crm::Arena::Regular::TonBattle::Day1.name,
          user: user,
