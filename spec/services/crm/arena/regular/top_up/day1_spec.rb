...
RSpec.describe Crm::Arena::Regular::TopUp::Day1 do
  ...
  context "when user's balance is zero" do
    ...
    let(:expected_text) { I18n.t("crm.arena.regular.top_up.day1.text") }
    let(:expected_button_text) { I18n.t("crm.arena.regular.top_up.day1.button") }
