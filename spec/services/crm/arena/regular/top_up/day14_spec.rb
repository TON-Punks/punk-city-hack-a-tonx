...
RSpec.describe Crm::Arena::Regular::TopUp::Day14 do
  ...
  context "when user's balance is zero" do
    ...
    let(:expected_text) { I18n.t("crm.arena.regular.top_up.day14.text") }
    let(:expected_button_text) { I18n.t("crm.arena.regular.top_up.day14.button") }
    ...
    context "when day7 notification sent" do
      before do
        create(:crm_notification,
          crm_type: Crm::Arena::Regular::TopUp::Day7.name,
          user: user,
