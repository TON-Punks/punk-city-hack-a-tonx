...
RSpec.describe Crm::Onboarding::Completed::Day7 do
  ...
  context "when user has onboarded" do
    ...
    let(:expected_text) { I18n.t("crm.onboarding.completed.day7.text") }
    let(:expected_button_text) { I18n.t("crm.onboarding.completed.day7.button") }
    ...
    context "when day4 notification sent" do
      before { create(:crm_notification, crm_type: Crm::Onboarding::Completed::Day4.name, user: user, created_at: 5.days.ago) }
