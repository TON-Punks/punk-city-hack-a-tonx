...
RSpec.describe Crm::Reactivation::TonBattle::Player::Day7 do
  ...
  context "when didn't play game last 10 days" do
    ...
    let(:expected_text) { I18n.t("crm.reactivation.ton_battle.player.day7.text") }
    let(:expected_button_text) { I18n.t("crm.reactivation.ton_battle.player.day7.button") }
    ...
    context "when day1 notification sent" do
      before do
        create(:crm_notification,
          crm_type: Crm::Reactivation::TonBattle::Player::Day1.name,
          user: user,
