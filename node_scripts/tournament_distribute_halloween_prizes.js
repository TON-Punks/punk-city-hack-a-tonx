...
let top4 = Address.parse(process.env.TOP4_ADDRESS)
let top5 = Address.parse(process.env.TOP5_ADDRESS)

const extraAddressesBuilder = new Cell();
extraAddressesBuilder.bits.writeAddress(top4);
extraAddressesBuilder.bits.writeAddress(top5);
...
bodyCell.withReference(extraAddressesBuilder);
